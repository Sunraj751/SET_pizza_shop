...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div style="width:1000px; height:195px; text-align:center; align-content:center; margin:0 auto; border:outset; background-color:#e8e8e8;">
                
                <asp:Table runat="server" style="margin:0 auto" BackColor="#e8e8e8" Width="800px">
                    <asp:TableRow Height="30px">
                        <asp:TableCell Width="300px">
                            <asp:Label Font-Size="20px" ID="lblGreeting" runat="server" Font-Names="Georgia" Text="Ciao"></asp:Label>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
               ...
               <br />
                ...
                <asp:Table runat="server" style="margin:0 auto" BackColor="#e8e8e8" Width="800px">
                  <asp:TableRow>
                        <asp:TableCell>
                            <asp:Label ID="lblTotalPrice" Font-Size="20px" runat="server" Font-Names="Georgia" Text="Total Cost: $10.00"></asp:Label>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
                ...
                <asp:Table runat="server" style="margin:0 auto" BackColor="#e8e8e8" Width="800px">
                  <asp:TableRow>
                        <asp:TableCell>
                            <asp:Button OnClick="btnSubmitOrder_Click" CssClass="regButton" ID="btnSubmitOrder" Font-Names="Georgia" Text="Make It!" runat="server" />
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
