...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <div style="width:1000px; height:125px; text-align:center; align-content:center; margin:0 auto; border:outset; background-color:#e8e8e8;">
                
               <asp:Table runat="server" style="margin:0 auto" BackColor="#e8e8e8" Width="800px">
                    <asp:TableRow Height="30px">
                        <asp:TableCell Width="300px">
                            <asp:Label Font-Size="20px" ID="lblWelcome" runat="server" Font-Names="Georgia" Text="Welcome to <i><b>SET Pizza Shop</b></i>. Enter Your Name to Continue."></asp:Label>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
                <br />
                <asp:Table ID="tblName" runat="server" style="margin:0 auto" BackColor="#e8e8e8" Width="800px">
                    <asp:TableRow Height="30px">
                        <asp:TableCell Width="300px">
                             <asp:Label runat="server" Font-Names="Georgia" Text="Please Enter Your First and Last Name"></asp:Label>
                        </asp:TableCell>
                        <asp:TableCell>
                            <asp:TextBox placeholder="(e.g. Sean Clarke)" ID="txtName" Font-Names="Georgia" runat="server" Width="200px" ToolTip="Enter Your Name"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell Width="300px">
                ...
                " BackColor="#e8e8e8" Width="800px">
                    <asp:TableRow Height="30px">
                        <asp:TableCell><asp:Button CssClass="regButton" ID="btnSubmitName" Font-Names="Georgia" Text="Submit" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
                            <br />
